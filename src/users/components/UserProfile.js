...
export default function ProfilePlaces() {
  ...
  const stats = {
    placeCount: userData.placeCount ?? 0,
    ...
    <React.Fragment>
      ...
      <div className="flex min-h-screen bg-gray-50 font-sans">
        ...
        <nav className="w-56 bg-white border-r border-gray-200 p-4 pt-8">
          ...
          <ul className="mb-8">
            <li className="my-2.5">
              <Link to={`/userFeed/${userId}`} className="text-gray-800 hover:text-green-800">
                Feed
              </Link>
            </li>
            <li className="my-2.5">
        ...
        <section className="flex-grow p-8 min-w-[460px]">
            ...
            <div className="flex-1">
              ...
              <div className="flex mb-5">
                <div className="mr-6 text-center">
                  <span className="block text-xl font-bold">{stats.placeCount}</span>
                  <span className="text-sm text-gray-600">Places</span>
                </div>
                <div className="mr-6 text-center">
                  <span className="block text-xl font-bold">{stats.followerCount}</span>
          ...
          <div className="flex mb-6 border-b border-gray-200">
            <button
              className={`flex items-center px-6 py-3 mr-2 ${activeTab === 'grid'
            ...
            <button
              className={`flex items-center px-6 py-3 mr-2 ${activeTab === 'list'
                  ? 'text-green-800 opacity-100 border-b-2 border-green-800 font-semibold'
                  : 'text-gray-600 opacity-70 hover:opacity-100'
                }`}
            ...
            <button
              className={`flex items-center px-6 py-3 mr-2 ${activeTab === 'map'
                  ? 'text-green-800 opacity-100 border-b-2 border-green-800 font-semibold'
                  : 'text-gray-600 opacity-70 hover:opacity-100'
                }`}
